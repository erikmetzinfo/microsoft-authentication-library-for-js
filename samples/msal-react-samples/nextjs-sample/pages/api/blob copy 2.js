...
export default async (req, res) => {
    ...
    try {
        ...
        form.parse(req, async (err, fields, files) => {
            ...
            const start = async () => {
                let requests = [];
                await asyncForEach(Object.keys(files), async (fileName) => {
            ...
            let requestIds = await start();
            console.log("requestIds", requestIds);
            // req.requestIds = requestIds;
            ...
            if (requestIds) {
                ...
                return res.json({ msg: requestIds });
            }
        ...
        // console.log("no error", requests);
    } catch (error) {
        console.log("error", error);
    }
    console.log("req.query.robotSystem", req.query.robotSystem);
    console.log("req.requestIds", req.requestIds);

    // TODO: create db entry
    res.json({ msg: req.requestIds });
